    ...
    */
    ...
    do
    {
        ...
        do
        {
            ...
            playerInput(&choice1row, &choice1column);
        ...
        } while (matrix[choice1row][choice1column] == -1 || (choice1row > MAX_SIZE_ROW || choice1row < 0) || (choice1column > MAX_SIZE_COLUMN || choice1column < 0) || error == 1); // check for invalid inputs.
        ...
        do
        {
            ...
            playerInput(&choice2row, &choice2column);
        ...
        } while (matrix[choice2row][choice2column] == -2 || (choice2row > MAX_SIZE_ROW || choice2row < 0) || (choice2column > MAX_SIZE_COLUMN || choice2column < 0) || (choice2row == choice1row && choice2column == choice1column) || error == 0);
